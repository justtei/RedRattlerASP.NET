...
{
	internal class EntityRelatedKeyValueStorage : KeyValueStorage
	{
		public EntityRelatedKeyValueStorage()
		{
			this.Table = new DataTable("KeyValueStorage");
			this.Table.Columns.Add(DataTableWrapper.GetDataColumn<long>("EntityId", true));
		...
		public void AddRow(long entityId, string key, object value)
		{
			long? nullable = null;
			string str = null;
			bool? nullable1 = null;
			...
			base.AddRow(new object[] { entityId, key, nullable, str, nullable1, nullable2, nullable3 });
		}
	}
}