...
namespace Main
{
	public class MvcApplication : HttpApplication
	{
		...
		{
			BundleTable.EnableOptimizations = ConfigurationManager.Instance.IsEnabledJsCssOptimization;
			...
			Bundle sharedLessBundle = new LessBundle("~/content/less/bundles/shared").Include("~/content/less/shared/*.less");
			Bundle adminLessBundle = new LessBundle("~/content/less/bundles/admin").Include("~/content/less/admin/*.less");
			Bundle clientLessBundle = new LessBundle("~/content/less/bundles/client").Include("~/content/less/client/*.less");
			bundles.Add(sharedLessBundle);
			bundles.Add(adminLessBundle);
			bundles.Add(clientLessBundle);
