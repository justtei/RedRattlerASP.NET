...
namespace UserManagementSystem.Web.Models
{
	public class CreateUserViewModel
	{
		...
		public Account ToBusinessEntity()
		{
			...
			account.CommunicationSettings = new UserManagementSystem.Shared.Entities.CommunicationSettings(this.CommunicationSettings.Leads, this.CommunicationSettings.Notifications);
			account.Role = this.SelectedRoleName;
