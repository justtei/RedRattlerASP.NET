	...
	public class CallTrackingPhoneVm
	{
		...
		public CallTrackingPhone ToEntity()
		{
			...
			if (!callTrackingPhone.IsDisconnected)
			{
				...
				nullable.ReconnectDate = new DateTime?((reconnectDate.HasValue ? reconnectDate.GetValueOrDefault() : DateTime.Now));
			}
			else
			{
				reconnectDate = null;
				...
				nullable1.DisconnectDate = new DateTime?((reconnectDate.HasValue ? reconnectDate.GetValueOrDefault() : DateTime.Now));
			}
