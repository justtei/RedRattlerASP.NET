...
{
	internal class CommunityShortVmFormatter : Formatter<CommunityShortVm, EntityLocation>
	{
		public CommunityShortVmFormatter()
		{
		}

		protected override void Apply(CommunityShortVm vm, EntityLocation location)
		{
			vm.DisplayProperties = vm.DisplayProperties.Community(vm.Package, location);
