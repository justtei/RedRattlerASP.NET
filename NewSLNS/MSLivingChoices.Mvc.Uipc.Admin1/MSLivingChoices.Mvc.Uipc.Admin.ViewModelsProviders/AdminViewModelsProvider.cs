...
namespace MSLivingChoices.Mvc.Uipc.Admin.ViewModelsProviders
{
	public static class AdminViewModelsProvider
	{
		...
		{
			return LocationBc.Instance.GetCities(stateId, searchType).Select<MSLivingChoices.Entities.Admin.City, SelectListItem>((MSLivingChoices.Entities.Admin.City c) => {
