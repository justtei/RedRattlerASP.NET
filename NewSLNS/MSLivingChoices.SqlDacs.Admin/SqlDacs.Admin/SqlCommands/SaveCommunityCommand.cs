...
{
	internal class SaveCommunityCommand : FreeCacheBaseCommand<Community>
	{
		...
		public SaveCommunityCommand(Community community, int publishTypeId, int showcaseTypeId, int couponTypeId, int customCommunityServiceTypeId)
		{
		...
		protected bool HasListingType(List<ListingType> list, ListingType type)
		{
