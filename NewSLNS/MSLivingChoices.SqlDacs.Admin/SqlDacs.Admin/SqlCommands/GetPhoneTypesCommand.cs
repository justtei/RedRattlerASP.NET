...
{
	internal class GetPhoneTypesCommand : ThreeParamGenericGetCommand
	{
		protected GetPhoneTypesCommand()
		{
			base.StoredProcedureName = AdminStoredProcedures.SpGetPhoneType;
			this.IdColumnName = "PhoneTypeId";
			this.DescriptionColumnName = "Description";
		}

		public GetPhoneTypesCommand(MSLivingChoices.Entities.Admin.Enums.CommunityType communityType) : this()
		{
		...
		public GetPhoneTypesCommand(MSLivingChoices.Entities.Admin.Enums.OwnerType ownerType) : this()
		{
			this.OwnerType = new MSLivingChoices.Entities.Admin.Enums.OwnerType?(ownerType);
			base.CacheKey = CachedBaseCommand<List<KeyValuePair<int, string>>>.GetCacheKey(new string[] { base.StoredProcedureName, this.CommunityType.ToString(), this.OwnerType.ToString(), this.ServiceType.ToString(), this.IdColumnName, this.DescriptionColumnName });
		}

		public GetPhoneTypesCommand(MSLivingChoices.Entities.Admin.Enums.ServiceType serviceType) : this()
		{
