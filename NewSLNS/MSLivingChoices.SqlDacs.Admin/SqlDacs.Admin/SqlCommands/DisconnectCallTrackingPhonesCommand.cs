...
{
	internal class DisconnectCallTrackingPhonesCommand : FreeCacheBaseCommand<List<CallTrackingPhone>>
	{
		private readonly Guid _userId;

		private readonly List<CallTrackingPhone> _callTrackingPhones;

		public DisconnectCallTrackingPhonesCommand(Guid userId, List<CallTrackingPhone> callTrackingPhones)
		{
			base.StoredProcedureName = AdminStoredProcedures.SpDisconnectCallTrackingPhones;
			this._userId = userId;
